...
# zombie_side
    execute as @a[team=Iruru.zombieteam] run function sys:repeat/zombieteam/
...
# movement
    # 41日~50日に常時実行
        execute if score $check iruru.check matches 1 if score $day iruru.daycount matches 41..50 run function sys:repeat/zombie_movement/
